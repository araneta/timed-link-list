...
/**
 * View class for a list of Timedlinklist.
 */
class TimedlinklistViewTypes extends JView
{
	protected $items;
	...
	{
		require_once JPATH_COMPONENT.DS.'helpers'.DS.'timedlinklist.php';

		$state	= $this->get('State');
		$canDo	= TimedlinklistHelper::getActions($state->get('filter.category_id'));

		JToolBarHelper::title(JText::_('COM_TIMEDLINKLIST_TITLE_TYPES'), 'types.png');

        //Check if the form exists before showing the add/edit buttons
        $formPath = JPATH_COMPONENT_ADMINISTRATOR.DS.'views'.DS.'type';
		...
		if ($canDo->get('core.admin')) {
			JToolBarHelper::preferences('com_timedlinklist');
		}
